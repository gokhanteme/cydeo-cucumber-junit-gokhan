...
public class Driver {
    ...
    public static WebDriver getDriver() {
       ...
       This way, we can control which browser is opened from out code, from configuration.properties.
        */
            String browserType = ConfigurationReader.getProperty("browser");
        /*
        Depending on the browserType that will be from configuration.properties
